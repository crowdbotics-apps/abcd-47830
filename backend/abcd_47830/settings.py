"""
Django settings for abcd_47830 project.
...
WSGI_APPLICATION = 'abcd_47830.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "abcd_47830 API",
    "DESCRIPTION": "API documentation for abcd_47830 App",
    "VERSION": "v1",
}
